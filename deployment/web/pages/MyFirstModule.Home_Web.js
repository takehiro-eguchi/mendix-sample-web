                            ...
                            <$Div key="p37.MyFirstModule.Home_Web.layoutGrid2$row0$column0"
                                ...
                                content={[
                                    ...
                                    <$Text key="p37.MyFirstModule.Home_Web.text3"
                                        ...
                                        renderMode={"p"} />,
                                    <$ConditionalVisibilityWrapper key="p37.MyFirstModule.Home_Web.actionButton1$visibility"
                                        $widgetId="p37.MyFirstModule.Home_Web.actionButton1$visibility"
                                    ...
                                    <$ConditionalVisibilityWrapper key="p37.MyFirstModule.Home_Web.actionButton7$visibility"
                                        $widgetId="p37.MyFirstModule.Home_Web.actionButton7$visibility"
                                        visible={ExpressionProperty({
                                            "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" }, { "type": "literal", "value": "User" }, { "type": "literal", "value": "SalesPerson" } ] }, "args": {} }
                                        })}
                                        contents={[
                                            <$ActionButton key="p37.MyFirstModule.Home_Web.actionButton7"
                                                ...
                                                action={ActionProperty({
                                                    "action": { "type": "callMicroflow", "argMap": {}, "config": { "operationId": "iMyed6qxUVmOM8pNMJEf5w", "validate": "view", "allowedRoles": [ "Administrator", "User", "SalesPerson" ] }, "disabledDuringExecution": true },
                                                    "abortOnServerValidation": true
                                                })} />
                                        ]} />
                                ]} />
            ...
            <$Div key="p37.MyFirstModule.Home_Web.layoutGrid1$row0"
                ...
                content={[
                    <$Div key="p37.MyFirstModule.Home_Web.layoutGrid1$row0$column0"
                        ...
                        style={undefined}
                        content={[
                            <$ConditionalVisibilityWrapper key="p37.MyFirstModule.Home_Web.actionButton2$visibility"
                                $widgetId="p37.MyFirstModule.Home_Web.actionButton2$visibility"
                                visible={ExpressionProperty({
                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" }, { "type": "literal", "value": "User" }, { "type": "literal", "value": "SalesPerson" } ] }, "args": {} }
                                })}
                                contents={[
                    ...
                    <$Div key="p37.MyFirstModule.Home_Web.layoutGrid1$row0$column1"
                        ...
                        style={undefined}
                        content={[
                            <$ConditionalVisibilityWrapper key="p37.MyFirstModule.Home_Web.actionButton5$visibility"
                                $widgetId="p37.MyFirstModule.Home_Web.actionButton5$visibility"
                                visible={ExpressionProperty({
                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" }, { "type": "literal", "value": "User" }, { "type": "literal", "value": "SalesPerson" } ] }, "args": {} }
                                })}
                                contents={[
            ...
            <$Div key="p37.MyFirstModule.Home_Web.layoutGrid1$row1"
                ...
                content={[
                    <$Div key="p37.MyFirstModule.Home_Web.layoutGrid1$row1$column0"
                        ...
                        style={undefined}
                        content={[
                            <$ConditionalVisibilityWrapper key="p37.MyFirstModule.Home_Web.actionButton3$visibility"
                                $widgetId="p37.MyFirstModule.Home_Web.actionButton3$visibility"
                                visible={ExpressionProperty({
                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" }, { "type": "literal", "value": "User" }, { "type": "literal", "value": "SalesPerson" } ] }, "args": {} }
                                })}
                                contents={[
                    ...
                    <$Div key="p37.MyFirstModule.Home_Web.layoutGrid1$row1$column1"
                        ...
                        style={undefined}
                        content={[
                            <$ConditionalVisibilityWrapper key="p37.MyFirstModule.Home_Web.actionButton6$visibility"
                                $widgetId="p37.MyFirstModule.Home_Web.actionButton6$visibility"
                                visible={ExpressionProperty({
                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" }, { "type": "literal", "value": "User" }, { "type": "literal", "value": "SalesPerson" } ] }, "args": {} }
                                })}
                                contents={[
            ...
            <$Div key="p37.MyFirstModule.Home_Web.layoutGrid1$row2"
                ...
                content={[
                    <$Div key="p37.MyFirstModule.Home_Web.layoutGrid1$row2$column0"
                        ...
                        style={undefined}
                        content={[
                            <$ConditionalVisibilityWrapper key="p37.MyFirstModule.Home_Web.actionButton4$visibility"
                                $widgetId="p37.MyFirstModule.Home_Web.actionButton4$visibility"
                                visible={ExpressionProperty({
                                    "expression": { "expr": { "type": "function", "name": "_hasSomeRole", "parameters": [ { "type": "literal", "value": "Administrator" }, { "type": "literal", "value": "User" }, { "type": "literal", "value": "SalesPerson" } ] }, "args": {} }
                                })}
                                contents={[
