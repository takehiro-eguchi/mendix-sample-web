...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p0.MyFirstModule.SalesPersons_NewEdit.layoutGrid1"
        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.layoutGrid1"
        class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p0.MyFirstModule.SalesPersons_NewEdit.layoutGrid1$row0"
                $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.layoutGrid1$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p0.MyFirstModule.SalesPersons_NewEdit.layoutGrid1$row0$column0"
                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.layoutGrid1$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$DataView key="p0.MyFirstModule.SalesPersons_NewEdit.dataView6"
                                ...
                                body={[
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.textBox1$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.textBox1$formGroup"
                                        class={"mx-name-textBox1 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p0.MyFirstModule.SalesPersons_NewEdit.textBox1"
                                    ...
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.textBox2$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.textBox2$formGroup"
                                        class={"mx-name-textBox2 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p0.MyFirstModule.SalesPersons_NewEdit.textBox2"
                                    ...
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.textBox3$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.textBox3$formGroup"
                                        class={"mx-name-textBox3 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p0.MyFirstModule.SalesPersons_NewEdit.textBox3"
                                    ...
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.datePicker1$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.datePicker1$formGroup"
                                        class={"mx-name-datePicker1 mx-datepicker"}
                                        style={undefined}
                                        control={[
                                            <$DatePicker key="p0.MyFirstModule.SalesPersons_NewEdit.datePicker1"
                                    ...
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.datePicker2$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.datePicker2$formGroup"
                                        class={"mx-name-datePicker2 mx-datepicker"}
                                        style={undefined}
                                        control={[
                                            <$DatePicker key="p0.MyFirstModule.SalesPersons_NewEdit.datePicker2"
                                    ...
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons1$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons1$formGroup"
                                        class={"mx-name-radioButtons1 mx-radiobuttons inline"}
                                        style={undefined}
                                        control={[
                                            <$RadioButtonGroup key="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons1"
                                    ...
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons2$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons2$formGroup"
                                        class={"mx-name-radioButtons2 mx-radiobuttons inline"}
                                        style={undefined}
                                        control={[
                                            <$RadioButtonGroup key="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons2"
                                    ...
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.textBox4$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.textBox4$formGroup"
                                        class={"mx-name-textBox4 mx-textbox"}
                                        style={undefined}
                                        control={[
                                            <$TextBox key="p0.MyFirstModule.SalesPersons_NewEdit.textBox4"
                                    ...
                                    <$FormGroup key="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons3$formGroup"
                                        $widgetId="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons3$formGroup"
                                        class={"mx-name-radioButtons3 mx-radiobuttons inline"}
                                        style={undefined}
                                        control={[
                                            <$RadioButtonGroup key="p0.MyFirstModule.SalesPersons_NewEdit.radioButtons3"
                                ...
                                hideFooter={false}
                                footer={[
                                    <$ActionButton key="p0.MyFirstModule.SalesPersons_NewEdit.actionButton1"
                                    ...
                                    <$ActionButton key="p0.MyFirstModule.SalesPersons_NewEdit.actionButton2"
