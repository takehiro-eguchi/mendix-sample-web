...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$ListView key="p1.MyFirstModule.CuttomerMobilePage.listView3"
        ...
        itemTemplate={TemplatedWidgetProperty({
            ...
            "editable": false,
            "children": () => [
                <$Container key="p1.MyFirstModule.CuttomerMobilePage.container1"
                    ...
                    onClick={undefined}
                    content={[
                        <$Text key="p1.MyFirstModule.CuttomerMobilePage.text10"
                    ...
                    ariaHidden={false} />,
                <$Container key="p1.MyFirstModule.CuttomerMobilePage.container2"
                    ...
                    onClick={undefined}
                    content={[
                        <$Text key="p1.MyFirstModule.CuttomerMobilePage.text11"
                        ...
                        <$Text key="p1.MyFirstModule.CuttomerMobilePage.text3"
                            ...
                            renderMode={"span"} />,
                        <$Container key="p1.MyFirstModule.CuttomerMobilePage.container3"
                            ...
                            onClick={undefined}
                            content={[
                                <$Text key="p1.MyFirstModule.CuttomerMobilePage.text12"
                                ...
                                <$Text key="p1.MyFirstModule.CuttomerMobilePage.text4"
                                    ...
                                    renderMode={"span"} />,
                                <$Container key="p1.MyFirstModule.CuttomerMobilePage.container4"
                                    ...
                                    onClick={undefined}
                                    content={[
                                        <$Text key="p1.MyFirstModule.CuttomerMobilePage.text13"
                                        ...
                                        <$Text key="p1.MyFirstModule.CuttomerMobilePage.text6"
                                            ...
                                            renderMode={"span"} />,
                                        <$Container key="p1.MyFirstModule.CuttomerMobilePage.container5"
                                            ...
                                            onClick={undefined}
                                            content={[
                                                <$Text key="p1.MyFirstModule.CuttomerMobilePage.text14"
