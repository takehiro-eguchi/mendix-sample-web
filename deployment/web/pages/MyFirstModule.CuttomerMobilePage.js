...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$ListView key="p29.MyFirstModule.CuttomerMobilePage.listView3"
        ...
        onClick={ListActionProperty({
            "action": { "type": "openPage", "argMap": { "param$Customers": { "widget": "p29.MyFirstModule.CuttomerMobilePage.listView3", "source": "object" } }, "config": { "name": "MyFirstModule/Customers_EditView.page.xml", "location": "content", "allowedRoles": [ "Administrator", "User", "SalesPerson" ] }, "disabledDuringExecution": true },
