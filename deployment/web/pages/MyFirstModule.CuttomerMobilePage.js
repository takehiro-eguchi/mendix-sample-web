...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$ListView key="p46.MyFirstModule.CuttomerMobilePage.listView3"
        ...
        itemTemplate={TemplatedWidgetProperty({
            ...
            "editable": false,
            "children": () => [
                <$Container key="p46.MyFirstModule.CuttomerMobilePage.container1"
                    ...
                    onClick={undefined}
                    content={[
                        <$Text key="p46.MyFirstModule.CuttomerMobilePage.text10"
                            ...
                            renderMode={"span"} />,
                        <$Text key="p46.MyFirstModule.CuttomerMobilePage.text1"
                            ...
                            renderMode={"span"} />,
                        <$Text key="p46.MyFirstModule.CuttomerMobilePage.text2"
                    ...
                    ariaHidden={false} />,
                <$Container key="p46.MyFirstModule.CuttomerMobilePage.container2"
                    ...
                    onClick={undefined}
                    content={[
                        <$Text key="p46.MyFirstModule.CuttomerMobilePage.text11"
                            ...
                            renderMode={"span"} />,
                        <$Text key="p46.MyFirstModule.CuttomerMobilePage.text3"
                            ...
                            renderMode={"span"} />,
                        <$Container key="p46.MyFirstModule.CuttomerMobilePage.container3"
                            ...
                            onClick={undefined}
                            content={[
                                <$Text key="p46.MyFirstModule.CuttomerMobilePage.text12"
                                    ...
                                    renderMode={"span"} />,
                                <$Text key="p46.MyFirstModule.CuttomerMobilePage.text5"
                                    ...
                                    renderMode={"span"} />,
                                <$Text key="p46.MyFirstModule.CuttomerMobilePage.text4"
                                    ...
                                    renderMode={"span"} />,
                                <$Container key="p46.MyFirstModule.CuttomerMobilePage.container4"
                                    ...
                                    onClick={undefined}
                                    content={[
                                        <$Text key="p46.MyFirstModule.CuttomerMobilePage.text13"
                                            ...
                                            renderMode={"span"} />,
                                        <$Text key="p46.MyFirstModule.CuttomerMobilePage.text7"
                                            ...
                                            renderMode={"span"} />,
                                        <$Text key="p46.MyFirstModule.CuttomerMobilePage.text6"
                                            ...
                                            renderMode={"span"} />,
                                        <$Container key="p46.MyFirstModule.CuttomerMobilePage.container5"
                                            ...
                                            onClick={undefined}
                                            content={[
                                                <$Text key="p46.MyFirstModule.CuttomerMobilePage.text14"
                                                    ...
                                                    renderMode={"span"} />,
                                                <$Text key="p46.MyFirstModule.CuttomerMobilePage.text8"
                                                    ...
                                                    renderMode={"span"} />,
                                                <$Text key="p46.MyFirstModule.CuttomerMobilePage.text9"
