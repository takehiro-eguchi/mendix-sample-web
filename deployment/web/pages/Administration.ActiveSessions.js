...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Container key="p2.Administration.ActiveSessions.container1"
        ...
        onClick={undefined}
        content={[
            <$Div key="p2.Administration.ActiveSessions.layoutGrid1"
                $widgetId="p2.Administration.ActiveSessions.layoutGrid1"
                class={"mx-name-layoutGrid1 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
                style={undefined}
                content={[
                    <$Div key="p2.Administration.ActiveSessions.layoutGrid1$row0"
                        $widgetId="p2.Administration.ActiveSessions.layoutGrid1$row0"
                        class={"row"}
                        style={undefined}
                        content={[
                            <$Div key="p2.Administration.ActiveSessions.layoutGrid1$row0$column0"
                                $widgetId="p2.Administration.ActiveSessions.layoutGrid1$row0$column0"
                                class={"col-lg-12 col-md-12 col-12"}
                                style={undefined}
                                content={[
                                    <$Text key="p2.Administration.ActiveSessions.label1"
        ...
        ariaHidden={false} />,
    <$Div key="p2.Administration.ActiveSessions.layoutGrid2"
        $widgetId="p2.Administration.ActiveSessions.layoutGrid2"
        class={"mx-name-layoutGrid2 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p2.Administration.ActiveSessions.layoutGrid2$row0"
                $widgetId="p2.Administration.ActiveSessions.layoutGrid2$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p2.Administration.ActiveSessions.layoutGrid2$row0$column0"
                        $widgetId="p2.Administration.ActiveSessions.layoutGrid2$row0$column0"
                        class={"col-lg-12 col-md-12 col-12"}
                        style={undefined}
                        content={[
                            <$Datagrid key="p2.Administration.ActiveSessions.dataGrid21"
                                ...
                                columns={[
                                    {
                                        ...
                                        "filter": [
                                            <$DatagridTextFilter key="p2.Administration.ActiveSessions.textFilter1"
                                    ...
                                    },
                                    {
                                        ...
                                        "filter": [
                                            <$DatagridDateFilter key="p2.Administration.ActiveSessions.dateFilter1"
