...
import * as DatagridNumberFilterWidgetModule from "C:/Users/nss430011/Mendix/SalesManagement/deployment/web/widgets/com/mendix/widget/web/datagridnumberfilter/DatagridNumberFilter.mjs";
...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Div key="p33.MyFirstModule.SalesPersonPage.layoutGrid4"
        $widgetId="p33.MyFirstModule.SalesPersonPage.layoutGrid4"
        class={"mx-name-layoutGrid4 mx-layoutgrid mx-layoutgrid-fluid container-fluid"}
        style={undefined}
        content={[
            <$Div key="p33.MyFirstModule.SalesPersonPage.layoutGrid4$row0"
                $widgetId="p33.MyFirstModule.SalesPersonPage.layoutGrid4$row0"
                class={"row"}
                style={undefined}
                content={[
                    <$Div key="p33.MyFirstModule.SalesPersonPage.layoutGrid4$row0$column0"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.layoutGrid4$row0$column0"
                        class={"col-lg col-md col"}
                        style={undefined}
                        content={[
                            <$Container key="p33.MyFirstModule.SalesPersonPage.container1"
                                $widgetId="p33.MyFirstModule.SalesPersonPage.container1"
                                class={"mx-name-container1 pageheader spacing-outer-bottom-large"}
                                style={undefined}
                                renderMode={"div"}
                                onClick={undefined}
                                content={[
                                    <$Div key="p33.MyFirstModule.SalesPersonPage.layoutGrid2"
                                        $widgetId="p33.MyFirstModule.SalesPersonPage.layoutGrid2"
                                        class={"mx-name-layoutGrid2 mx-layoutgrid mx-layoutgrid-fluid"}
                                        style={undefined}
                                        content={[
                                            <$Div key="p33.MyFirstModule.SalesPersonPage.layoutGrid2$row0"
                                                $widgetId="p33.MyFirstModule.SalesPersonPage.layoutGrid2$row0"
                                                class={"row"}
                                                style={undefined}
                                                content={[
                                                    <$Div key="p33.MyFirstModule.SalesPersonPage.layoutGrid2$row0$column0"
                                                        $widgetId="p33.MyFirstModule.SalesPersonPage.layoutGrid2$row0$column0"
                                                        class={"col-lg col-md col"}
                                                        style={undefined}
                                                        content={[
                                                            <$Text key="p33.MyFirstModule.SalesPersonPage.text40"
                                                                $widgetId="p33.MyFirstModule.SalesPersonPage.text40"
                                                                ...
                                                                renderMode={"h1"} />,
                                                            <$Text key="p33.MyFirstModule.SalesPersonPage.text39"
                                                                $widgetId="p33.MyFirstModule.SalesPersonPage.text39"
    ...
    <$Datagrid key="p33.MyFirstModule.SalesPersonPage.dataGrid2_1"
        $widgetId="p33.MyFirstModule.SalesPersonPage.dataGrid2_1"
        advanced={false}
        ...
        columns={[
            {
                ...
                "filter": [
                    <$DatagridTextFilter key="p33.MyFirstModule.SalesPersonPage.textFilter1"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.textFilter1"
                        advanced={false}
            ...
            },
            {
                ...
                "filter": [
                    <$DatagridTextFilter key="p33.MyFirstModule.SalesPersonPage.textFilter2"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.textFilter2"
                        advanced={false}
                        defaultValue={undefined}
                        defaultFilter={"contains"}
                        placeholder={t([
            ...
            },
            {
                ...
                "filter": [
                    <$DatagridTextFilter key="p33.MyFirstModule.SalesPersonPage.textFilter3"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.textFilter3"
                        advanced={false}
                        defaultValue={undefined}
                        defaultFilter={"contains"}
                        placeholder={t([
            ...
            },
            {
                ...
                "filter": [
                    <$DatagridDateFilter key="p33.MyFirstModule.SalesPersonPage.dateFilter1"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.dateFilter1"
                        advanced={false}
                        defaultValue={undefined}
            ...
            },
            {
                ...
                "filter": [
                    <$DatagridDateFilter key="p33.MyFirstModule.SalesPersonPage.dateFilter2"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.dateFilter2"
                        advanced={false}
                        defaultValue={undefined}
                        defaultStartDate={undefined}
                        defaultEndDate={undefined}
            ...
            },
            {
                ...
                "filter": [
                    <$DatagridDropdownFilter key="p33.MyFirstModule.SalesPersonPage.drop_downFilter1"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.drop_downFilter1"
                        auto={true}
                        defaultValue={undefined}
                        filterOptions={[]}
                        filterable={false}
            ...
            },
            {
                ...
                "filter": [
                    <$DatagridDropdownFilter key="p33.MyFirstModule.SalesPersonPage.drop_downFilter2"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.drop_downFilter2"
                        auto={true}
                        defaultValue={undefined}
                        filterOptions={[]}
                        filterable={false}
            ...
            },
            {
                ...
                "filter": [
                    <$DatagridNumberFilter key="p33.MyFirstModule.SalesPersonPage.numberFilter1"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.numberFilter1"
                        advanced={false}
                        defaultValue={undefined}
                        defaultFilter={"equal"}
                        placeholder={t([
            ...
            },
            {
                ...
                "filter": [
                    <$DatagridDropdownFilter key="p33.MyFirstModule.SalesPersonPage.drop_downFilter3"
                        $widgetId="p33.MyFirstModule.SalesPersonPage.drop_downFilter3"
                        auto={true}
                        defaultValue={undefined}
                        filterOptions={[]}
                        filterable={false}
            ...
            },
            {
                ...
                "content": TemplatedWidgetProperty({
                    ...
                    "editable": false,
                    "children": () => [
                        <$ActionButton key="p33.MyFirstModule.SalesPersonPage.actionButton1"
                            $widgetId="p33.MyFirstModule.SalesPersonPage.actionButton1"
                            buttonId={"p33.MyFirstModule.SalesPersonPage.actionButton1"}
                            ...
                            action={ActionProperty({
                                "action": { "type": "openPage", "argMap": { "param$SalesPersons": { "widget": "p33.MyFirstModule.SalesPersonPage.dataGrid2_1", "source": "object" } }, "config": { "name": "MyFirstModule/SalesPersons_NewEdit.page.xml", "location": "content" }, "disabledDuringExecution": true },
                                "abortOnServerValidation": true
                            })} />,
                        <$ActionButton key="p33.MyFirstModule.SalesPersonPage.actionButton2"
                            $widgetId="p33.MyFirstModule.SalesPersonPage.actionButton2"
                            buttonId={"p33.MyFirstModule.SalesPersonPage.actionButton2"}
                            ...
                            action={ActionProperty({
                                "action": { "type": "deleteObject", "argMap": { "$object": { "widget": "p33.MyFirstModule.SalesPersonPage.dataGrid2_1", "source": "object" } }, "config": { "closePage": false, "operationId": "bmXP0+E4glmjhaNXAfkMZw" }, "disabledDuringExecution": true },
                                "abortOnServerValidation": true
                            })} />
                    ]
                }),
        ...
        filterList={[]}
        filtersPlaceholder={[
            <$ActionButton key="p33.MyFirstModule.SalesPersonPage.actionButton3"
                $widgetId="p33.MyFirstModule.SalesPersonPage.actionButton3"
                buttonId={"p33.MyFirstModule.SalesPersonPage.actionButton3"}
