...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$Container key="p0.MyFirstModule.HomePage.container9"
        ...
        onClick={undefined}
        content={[
            <$Container key="p0.MyFirstModule.HomePage.container10"
                ...
                onClick={undefined}
                content={[
                    <$ActionButton key="p0.MyFirstModule.HomePage.actionButton1"
                        ...
                        action={undefined} />,
                    <$Container key="p0.MyFirstModule.HomePage.container8"
                        ...
                        onClick={undefined}
                        content={[
                            <$Text key="p0.MyFirstModule.HomePage.text1"
                                ...
                                renderMode={"h1"} />,
                            <$Text key="p0.MyFirstModule.HomePage.text2"
                ...
                ariaHidden={false} />,
            <$Div key="p0.MyFirstModule.HomePage.layoutGrid1"
                ...
                style={undefined}
                content={[
                    <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row0"
                        $widgetId="p0.MyFirstModule.HomePage.layoutGrid1$row0"
                        class={"row"}
                        style={undefined}
                        content={[
                            <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row0$column0"
                                $widgetId="p0.MyFirstModule.HomePage.layoutGrid1$row0$column0"
                                class={"col-lg col-md col"}
                                style={undefined}
                                content={[
                                    <$Container key="p0.MyFirstModule.HomePage.container2"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$ActionButton key="p0.MyFirstModule.HomePage.actionButton17"
                            ...
                            <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row0$column1"
                                $widgetId="p0.MyFirstModule.HomePage.layoutGrid1$row0$column1"
                                class={"col-lg col-md col"}
                                style={undefined}
                                content={[
                                    <$Container key="p0.MyFirstModule.HomePage.container3"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$ActionButton key="p0.MyFirstModule.HomePage.actionButton18"
                    ...
                    <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row1"
                        $widgetId="p0.MyFirstModule.HomePage.layoutGrid1$row1"
                        class={"row"}
                        style={undefined}
                        content={[
                            <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row1$column0"
                                $widgetId="p0.MyFirstModule.HomePage.layoutGrid1$row1$column0"
                                class={"col-lg col-md col"}
                                style={undefined}
                                content={[
                                    <$Container key="p0.MyFirstModule.HomePage.container4"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$ActionButton key="p0.MyFirstModule.HomePage.actionButton19"
                                                ...
                                                action={undefined} />,
                                            <$Text key="p0.MyFirstModule.HomePage.text5"
                            ...
                            <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row1$column1"
                                $widgetId="p0.MyFirstModule.HomePage.layoutGrid1$row1$column1"
                                class={"col-lg col-md col"}
                                style={undefined}
                                content={[
                                    <$Container key="p0.MyFirstModule.HomePage.container5"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$ActionButton key="p0.MyFirstModule.HomePage.actionButton20"
                                                ...
                                                action={undefined} />,
                                            <$Text key="p0.MyFirstModule.HomePage.text6"
                    ...
                    <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row2"
                        $widgetId="p0.MyFirstModule.HomePage.layoutGrid1$row2"
                        class={"row"}
                        style={undefined}
                        content={[
                            <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row2$column0"
                                $widgetId="p0.MyFirstModule.HomePage.layoutGrid1$row2$column0"
                                class={"col-lg col-md col"}
                                style={undefined}
                                content={[
                                    <$Container key="p0.MyFirstModule.HomePage.container6"
                                        ...
                                        onClick={undefined}
                                        content={[
                                            <$ActionButton key="p0.MyFirstModule.HomePage.actionButton21"
                                                ...
                                                action={undefined} />,
                                            <$Text key="p0.MyFirstModule.HomePage.text7"
                            ...
                            <$Div key="p0.MyFirstModule.HomePage.layoutGrid1$row2$column1"
