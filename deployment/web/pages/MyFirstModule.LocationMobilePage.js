...
const region$Main = (historyId) => (<PageFragment renderKey={historyId}>{[
    <$ListView key="p31.MyFirstModule.LocationMobilePage.listView3"
        ...
        itemTemplate={TemplatedWidgetProperty({
            ...
            "editable": false,
            "children": () => [
                <$Text key="p31.MyFirstModule.LocationMobilePage.text1"
                    ...
                    renderMode={"p"} />,
                <$Text key="p31.MyFirstModule.LocationMobilePage.text2"
                    ...
                    renderMode={"p"} />,
                <$Text key="p31.MyFirstModule.LocationMobilePage.text3"
                    ...
                    renderMode={"p"} />,
                <$Text key="p31.MyFirstModule.LocationMobilePage.text4"
                    ...
                    renderMode={"p"} />,
                <$Text key="p31.MyFirstModule.LocationMobilePage.text5"
                    ...
                    renderMode={"p"} />,
                <$Text key="p31.MyFirstModule.LocationMobilePage.text6"
