...
const region$Main = [
    <$ScrollContainer key="l39.Atlas_Core.Tablet_Split_Equal.layoutContainer"
        $widgetId="l39.Atlas_Core.Tablet_Split_Equal.layoutContainer"
        ...
        top={{
            "enabled": true,
            "content": [
                <$Header key="l39.Atlas_Core.Tablet_Split_Equal.header1"
                    $widgetId="l39.Atlas_Core.Tablet_Split_Equal.header1"
                    ...
                    leftWidgets={[
                        <$Placeholder key="l39.Atlas_Core.Tablet_Split_Equal.HeaderLeft"
                            $widgetId="l39.Atlas_Core.Tablet_Split_Equal.HeaderLeft"
                            content={PlaceholderProperty({
                                "id": "Atlas_Core.Tablet_Split_Equal.HeaderLeft"
                            })} />
                    ]}
                    rightWidgets={[
                        <$Placeholder key="l39.Atlas_Core.Tablet_Split_Equal.HeaderRight"
                            $widgetId="l39.Atlas_Core.Tablet_Split_Equal.HeaderRight"
                            content={PlaceholderProperty({
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l39.Atlas_Core.Tablet_Split_Equal.simpleMenuBar1"
                    $widgetId="l39.Atlas_Core.Tablet_Split_Equal.simpleMenuBar1"
        ...
        left={{
            "enabled": true,
            "content": [
                <$Placeholder key="l39.Atlas_Core.Tablet_Split_Equal.Left"
                    $widgetId="l39.Atlas_Core.Tablet_Split_Equal.Left"
                    content={PlaceholderProperty({
        ...
        center={{
            "content": [
                <$Placeholder key="l39.Atlas_Core.Tablet_Split_Equal.Main"
                    $widgetId="l39.Atlas_Core.Tablet_Split_Equal.Main"
                    content={PlaceholderProperty({
