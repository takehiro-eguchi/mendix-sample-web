...
const region$Main = [
    <$ScrollContainer key="l12.Atlas_Core.Tablet_BottomBar.layoutContainer"
        $widgetId="l12.Atlas_Core.Tablet_BottomBar.layoutContainer"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l12.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
                    $widgetId="l12.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l12.Atlas_Core.Tablet_BottomBar.Main"
                    $widgetId="l12.Atlas_Core.Tablet_BottomBar.Main"
