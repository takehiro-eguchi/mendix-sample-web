...
const region$Main = [
    <$ScrollContainer key="l13.Atlas_Core.Tablet_BottomBar.layoutContainer"
        $widgetId="l13.Atlas_Core.Tablet_BottomBar.layoutContainer"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l13.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
                    $widgetId="l13.Atlas_Core.Tablet_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l13.Atlas_Core.Tablet_BottomBar.Main"
                    $widgetId="l13.Atlas_Core.Tablet_BottomBar.Main"
