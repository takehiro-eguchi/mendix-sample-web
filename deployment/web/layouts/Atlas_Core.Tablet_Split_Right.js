...
const region$Main = [
    <$ScrollContainer key="l14.Atlas_Core.Tablet_Split_Right.layoutContainer"
        $widgetId="l14.Atlas_Core.Tablet_Split_Right.layoutContainer"
        ...
        top={{
            "enabled": true,
            "content": [
                <$Header key="l14.Atlas_Core.Tablet_Split_Right.header1"
                    $widgetId="l14.Atlas_Core.Tablet_Split_Right.header1"
                    ...
                    leftWidgets={[
                        <$Placeholder key="l14.Atlas_Core.Tablet_Split_Right.HeaderLeft"
                            $widgetId="l14.Atlas_Core.Tablet_Split_Right.HeaderLeft"
                            content={PlaceholderProperty({
                                "id": "Atlas_Core.Tablet_Split_Right.HeaderLeft"
                            })} />
                    ]}
                    rightWidgets={[
                        <$Placeholder key="l14.Atlas_Core.Tablet_Split_Right.HeaderRight"
                            $widgetId="l14.Atlas_Core.Tablet_Split_Right.HeaderRight"
                            content={PlaceholderProperty({
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l14.Atlas_Core.Tablet_Split_Right.simpleMenuBar1"
                    $widgetId="l14.Atlas_Core.Tablet_Split_Right.simpleMenuBar1"
        ...
        right={{
            "enabled": true,
            "content": [
                <$Placeholder key="l14.Atlas_Core.Tablet_Split_Right.Right"
                    $widgetId="l14.Atlas_Core.Tablet_Split_Right.Right"
                    content={PlaceholderProperty({
        ...
        center={{
            "content": [
                <$Placeholder key="l14.Atlas_Core.Tablet_Split_Right.Main"
                    $widgetId="l14.Atlas_Core.Tablet_Split_Right.Main"
                    content={PlaceholderProperty({
