...
const region$Main = [
    <$ScrollContainer key="l9.Atlas_Core.Phone_Default.scrollContainer1"
        ...
        top={{
            "enabled": true,
            "content": [
                <$Header key="l9.Atlas_Core.Phone_Default.header1"
                    ...
                    leftWidgets={[
                        <$Placeholder key="l9.Atlas_Core.Phone_Default.HeaderLeft"
                    ...
                    rightWidgets={[
                        <$Placeholder key="l9.Atlas_Core.Phone_Default.HeaderRight"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l9.Atlas_Core.Phone_Default.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l9.Atlas_Core.Phone_Default.Main"
