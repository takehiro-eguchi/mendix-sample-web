...
const region$Main = [
    <$ScrollContainer key="l11.Atlas_Core.Phone_BottomBar.scrollContainer1"
        ...
        bottom={{
            "enabled": true,
            "content": [
                <$SimpleMenuBar key="l11.Atlas_Core.Phone_BottomBar.simpleMenuBar1"
        ...
        center={{
            "content": [
                <$Placeholder key="l11.Atlas_Core.Phone_BottomBar.Main"
