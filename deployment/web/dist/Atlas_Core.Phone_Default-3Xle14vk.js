import { jsxRuntimeExports, classNames, reactExports, asPluginWidgets, PlaceholderProperty, selectTranslation } from './index-byXJmgeF.js';
import { ScrollContainer, Placeholder, ExpressionProperty } from './ScrollContainer-BNFOh2As.js';
import { TextProperty } from './Icon-BZqjj_0y.js';
import { WebIconProperty } from './WebIconProperty-Dlq3RviU.js';
import { SimpleMenuBar } from './SimpleMenuBar-cbI6aqB4.js';
import { InlineText } from './InlineText-D7jZL5NZ.js';
...
const region$Main = [
  /* @__PURE__ */ React.createElement(
    $ScrollContainer,
    {
      key: "l9.Atlas_Core.Phone_Default.scrollContainer1",
      $widgetId: "l9.Atlas_Core.Phone_Default.scrollContainer1",
      ...
      top: {
        ...
        "content": [
          /* @__PURE__ */ React.createElement(
            $Header,
            {
              key: "l9.Atlas_Core.Phone_Default.header1",
              $widgetId: "l9.Atlas_Core.Phone_Default.header1",
              ...
              leftWidgets: [
                /* @__PURE__ */ React.createElement(
                  $Placeholder,
                  {
                    key: "l9.Atlas_Core.Phone_Default.HeaderLeft",
                    $widgetId: "l9.Atlas_Core.Phone_Default.HeaderLeft",
              ...
              rightWidgets: [
                /* @__PURE__ */ React.createElement(
                  $Placeholder,
                  {
                    key: "l9.Atlas_Core.Phone_Default.HeaderRight",
                    $widgetId: "l9.Atlas_Core.Phone_Default.HeaderRight",
                    content: PlaceholderProperty({
      ...
      bottom: {
        ...
        "content": [
          /* @__PURE__ */ React.createElement(
            $SimpleMenuBar,
            {
              key: "l9.Atlas_Core.Phone_Default.simpleMenuBar1",
              $widgetId: "l9.Atlas_Core.Phone_Default.simpleMenuBar1",
      ...
      center: {
        "content": [
          /* @__PURE__ */ React.createElement(
            $Placeholder,
            {
              key: "l9.Atlas_Core.Phone_Default.Main",
              $widgetId: "l9.Atlas_Core.Phone_Default.Main",
              content: PlaceholderProperty({
