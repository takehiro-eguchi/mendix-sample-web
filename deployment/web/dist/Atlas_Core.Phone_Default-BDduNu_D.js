import { jsxRuntimeExports, classNames, reactExports, asPluginWidgets, PlaceholderProperty, selectTranslation } from './index-BCA8X3MP.js';
import { ScrollContainer, Placeholder, ExpressionProperty } from './ScrollContainer-BdzcW3SP.js';
...
import { InlineText } from './InlineText-BU8NLTPl.js';
...
const region$Main = [
  /* @__PURE__ */ React.createElement(
    $ScrollContainer,
    {
      key: "l11.Atlas_Core.Phone_Default.scrollContainer1",
      $widgetId: "l11.Atlas_Core.Phone_Default.scrollContainer1",
      ...
      top: {
        ...
        "content": [
          /* @__PURE__ */ React.createElement(
            $Header,
            {
              key: "l11.Atlas_Core.Phone_Default.header1",
              $widgetId: "l11.Atlas_Core.Phone_Default.header1",
              ...
              leftWidgets: [
                /* @__PURE__ */ React.createElement(
                  $Placeholder,
                  {
                    key: "l11.Atlas_Core.Phone_Default.HeaderLeft",
                    $widgetId: "l11.Atlas_Core.Phone_Default.HeaderLeft",
              ...
              rightWidgets: [
                /* @__PURE__ */ React.createElement(
                  $Placeholder,
                  {
                    key: "l11.Atlas_Core.Phone_Default.HeaderRight",
                    $widgetId: "l11.Atlas_Core.Phone_Default.HeaderRight",
                    content: PlaceholderProperty({
      ...
      bottom: {
        ...
        "content": [
          /* @__PURE__ */ React.createElement(
            $SimpleMenuBar,
            {
              key: "l11.Atlas_Core.Phone_Default.simpleMenuBar1",
              $widgetId: "l11.Atlas_Core.Phone_Default.simpleMenuBar1",
      ...
      center: {
        "content": [
          /* @__PURE__ */ React.createElement(
            $Placeholder,
            {
              key: "l11.Atlas_Core.Phone_Default.Main",
              $widgetId: "l11.Atlas_Core.Phone_Default.Main",
              content: PlaceholderProperty({
